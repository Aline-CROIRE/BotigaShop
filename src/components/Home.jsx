...
<div className="sidebar">
      ...
      <section className="products">
        ...
        <div className="product-list">
          <div className="product"><img src={bottle} alt="All In One Bottle" /><p>All In One Bottle</p><span>$22.00 - $35.00</span><div className="rating">{[...Array(5)].map((_, i) => <FaStar key={i} />)}</div></div>
          <div className="product"><img src={alexa} alt="Amazon Alexa" /><p>Amazon Alexa</p><span>$49.00 - $60.00</span><div className="rating">{[...Array(5)].map((_, i) => <FaStar key={i} />)}</div></div>
          <div className="product"><img src={headset} alt="Headset Gamer Legion" /><p>Headset Gamer Legion</p><span>$22.00 - $55.00</span><div className="rating">{[...Array(5)].map((_, i) => <FaStar key={i} />)}</div></div>
        </div>
        <button className="shop-btn">SHOP NOW</button>
      </section>
      ...
      <section className="vendors">
        ...
        <div className="vendor-list">
          <div className="vendor"><img src={store1} alt="Santa Monica's Store" /><div className="vendor-info"><p>Santa Monica’s Store</p><span>New York, NY</span><FaChevronRight className="arrow-icon" /></div></div>
          <div className="vendor"><img src={store2} alt="Josh Doe's Store" /><div className="vendor-info"><p>Josh Doe’s Store</p><span>New York, NY</span><FaChevronRight className="arrow-icon" /></div></div>
          <div className="vendor"><img src={store3} alt="Digital Good's Store" /><div className="vendor-info"><p>Digital Good’s Store</p><span>New York, NY</span><FaChevronRight className="arrow-icon" /></div></div>
          <div className="vendor"><img src={store4} alt="Jessica's Store" /><div className="vendor-info"><p>Jessica’s Store</p><span>New York, NY</span><FaChevronRight className="arrow-icon" /></div></div>
          <div className="vendor"><img src={store5} alt="The Glass Store" /><div className="vendor-info"><p>The Glass Store</p><span>New York, NY</span><FaChevronRight className="arrow-icon" /></div></div>
          <div className="vendor"><img src={store6} alt="John Doe's Store" /><div className="vendor-info"><p>John Doe’s Store</p><span>New York, NY</span><FaChevronRight className="arrow-icon" /></div></div>
        </div>
      </section>
